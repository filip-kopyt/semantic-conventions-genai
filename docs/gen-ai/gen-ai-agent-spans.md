...
- [Semantic Conventions for GenAI agent and framework spans](#semantic-conventions-for-genai-agent-and-framework-spans)
  ...
  - [Execute tool span](#execute-tool-span)
    ...
    - [Load skill span refinement](#load-skill-span-refinement)
    - [Read skill resource span refinement](#read-skill-resource-span-refinement)
    - [Command execution refinement](#command-execution-refinement)
...
[Execute Tool Span](./gen-ai-spans.md#execute-tool-span) and refinements below.
...
instrumentations SHOULD refine [Execute Tool span](./gen-ai-spans.md#execute-tool-span)
as described below.
...
### Load skill span refinement

<!-- weaver .refinements.spans[] | select(.id == "gen_ai.execute_tool.load_skill.internal") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
Describes a tool call that loads a skill into an agent's context.

This refinement applies when a dedicated tool loads a skill.
Examples include:
...
| [`gen_ai.skill.name`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Conditionally Required` If the skill name is available. | string | The name of the [Agent Skill](https://agentskills.io) the operation names. [3] | `code-review`; `pdf-processing` |
| [`gen_ai.skill.description`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` If the skill description is available. | string | The description of the skill, stating what it does and when to use it. [4] | `Review a changelist against the team's review policy.` |
| [`gen_ai.skill.source.uri`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` If the skill source URI is available. | string | The [RFC 3986](https://www.rfc-editor.org/rfc/rfc3986) URI of the source from which the skill was loaded. [5] | `https://skills.example.com/code-review`; `gs://example-skills/code-review`; `file:///opt/skills/code-review` |
...
**[4] `gen_ai.skill.description`:** This is the `description` field of the skill's `SKILL.md` frontmatter — the
...
For file-based skills, this is the URI of the skill directory. A local
source path MAY be converted to a `file` URI.
...
### Read skill resource span refinement

<!-- weaver .refinements.spans[] | select(.id == "gen_ai.execute_tool.read_skill_resource.internal") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
Describes a tool call that reads a resource belonging to a skill.

This refinement applies when a dedicated tool reads a skill resource.
Examples include:

- [Google ADK](https://adk.dev/skills/) `load_skill_resource`;
- [Microsoft Agent Framework](https://learn.microsoft.com/agent-framework/agents/skills)
  `read_skill_resource`;
- [Agno](https://docs.agno.com/skills/overview)
...
| [`gen_ai.agent.name`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Conditionally Required` When applicable. | string | The human-readable name of the agent executing the tool. | `Math Tutor`; `Fiction Writer` |
| [`gen_ai.skill.name`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Conditionally Required` If the skill name is available. | string | The name of the [Agent Skill](https://agentskills.io) the operation names. [3] | `code-review`; `pdf-processing` |
| [`gen_ai.skill.resource.name`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Conditionally Required` If the skill resource name is available. | string | The skill-relative name of the resource accessed or executed by the tool. [4] | `references/review_policy.md`; `assets/report_template.html` |
| [`gen_ai.skill.description`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` If the skill description is available. | string | The description of the skill, stating what it does and when to use it. [5] | `Review a changelist against the team's review policy.` |
| [`gen_ai.skill.source.uri`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` If the skill source URI is available. | string | The [RFC 3986](https://www.rfc-editor.org/rfc/rfc3986) URI of the source from which the skill was loaded. [6] | `https://skills.example.com/code-review`; `gs://example-skills/code-review`; `file:///opt/skills/code-review` |
| [`gen_ai.tool.call.id`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` If available. | string | The tool call identifier. | `call_mszuSIzqtI65i1wAUOE8w5H4` |
...
**[4] `gen_ai.skill.resource.name`:** This attribute records the logical resource name available from the tool
call or instrumented library state. It may be a skill-relative path when
the framework uses paths.

**[5] `gen_ai.skill.description`:** This is the `description` field of the skill's `SKILL.md` frontmatter — the
text the agent matches a task against when deciding to load the skill.
...
### Command execution refinement

<!-- weaver .refinements.spans[] | select(.id == "gen_ai.execute_tool.command.internal") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
This refinement applies when a tool represents command execution,
whether or not it is associated with a skill.

Examples include:

- [OpenAI Agents](https://openai.github.io/openai-agents-python/sandbox/guide/)
  `exec_command`, which runs both general commands and scripts from
  materialized skills;
...
- [Anthropic](https://platform.claude.com/docs/en/agents-and-tools/tool-use/bash-tool)
  client `bash` for general commands;
- [Google ADK](https://adk.dev/skills/) `run_skill_script`, which is
  dedicated to scripts bundled with skills;
- [Agno](https://docs.agno.com/skills/overview) `get_skill_script` when
  called with `execute=true`.

The tool span covers framework processing such as validation, skill
...
| [`error.type`](https://github.com/open-telemetry/semantic-conventions/blob/v1.44.0/docs/registry/attributes/error.md) | ![Stable](https://img.shields.io/badge/-stable-lightgreen) | `Conditionally Required` If the operation ended in an error. | string | Describes a class of error the operation ended with. [2] | `timeout`; `java.net.UnknownHostException`; `server_certificate_invalid`; `500` |
| [`gen_ai.agent.name`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Conditionally Required` When applicable. | string | The human-readable name of the agent executing the tool. | `Math Tutor`; `Fiction Writer` |
| [`gen_ai.skill.name`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Conditionally Required` [3] | string | The name of the [Agent Skill](https://agentskills.io) the operation names. [4] | `code-review`; `pdf-processing` |
| [`gen_ai.skill.resource.name`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Conditionally Required` [5] | string | The skill-relative name of the resource accessed or executed by the tool. [6] | `references/review_policy.md`; `assets/report_template.html` |
| [`process.executable.name`](https://github.com/open-telemetry/semantic-conventions/blob/v1.44.0/docs/registry/attributes/process.md) | ![Release Candidate](https://img.shields.io/badge/-rc-mediumorchid) | `Conditionally Required` [7] | string | The name of the process executable. On Linux based systems, this SHOULD be set to the base name of the target of `/proc/[pid]/exe`. On Windows, this SHOULD be set to the base name of `GetProcessImageFileNameW`. | `otelcol` |
| [`process.exit.code`](https://github.com/open-telemetry/semantic-conventions/blob/v1.44.0/docs/registry/attributes/process.md) | ![Release Candidate](https://img.shields.io/badge/-rc-mediumorchid) | `Conditionally Required` [8] | int | The exit code of the process. | `127` |
| [`gen_ai.skill.description`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` [9] | string | The description of the skill, stating what it does and when to use it. [10] | `Review a changelist against the team's review policy.` |
| [`gen_ai.skill.source.uri`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` [11] | string | The [RFC 3986](https://www.rfc-editor.org/rfc/rfc3986) URI of the source from which the skill was loaded. [12] | `https://skills.example.com/code-review`; `gs://example-skills/code-review`; `file:///opt/skills/code-review` |
| [`gen_ai.tool.call.id`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` If available. | string | The tool call identifier. | `call_mszuSIzqtI65i1wAUOE8w5H4` |
...
**[3] `gen_ai.skill.name`:** If the command is associated with a skill and its name is available.

**[4] `gen_ai.skill.name`:** The name the call asked for, recorded whether or not it resolves to a skill. Where it resolves, this is the `name` field of that skill's `SKILL.md` frontmatter, which the specification requires to be unique within the set of skills available to the agent.

**[5] `gen_ai.skill.resource.name`:** If the command executes a named skill resource and the name is available.

**[6] `gen_ai.skill.resource.name`:** This attribute records the logical resource name available from the tool
call or instrumented library state. It may be a skill-relative path when
the framework uses paths.

**[7] `process.executable.name`:** If the tool directly executes a single process and the executable name is available.

**[8] `process.exit.code`:** If the tool reports a single command or process exit code.

**[9] `gen_ai.skill.description`:** If the command is associated with a skill and its description is available.

**[10] `gen_ai.skill.description`:** This is the `description` field of the skill's `SKILL.md` frontmatter — the
text the agent matches a task against when deciding to load the skill.
